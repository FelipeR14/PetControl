    ...
    return (
        <View style={styles.VistaPrincipal}>
            ...
            <View style={styles.divBtns}>
                    <Button style={styles.btnLog} _text={{ color: "white",fontSize:'20px',fontWeight:500 }} onPress={() => irLogin()}> Login  </Button>
                    <Spacer height={5} />
                    <Button style={styles.btnReg} _text={{ color: "#1AB28E",fontSize:'20px',fontWeight:500  }} onPress={() => irRegister()}> Register  </Button>  
            </View>
        </View> 
    )
}
